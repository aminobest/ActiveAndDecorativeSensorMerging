...
2. A Jar Runnable version of ProM with ADSM plugin can be executed from runProMwithADSM.sh (Test dataset available at https://github.com/aminobest/ActiveAndDecorativeSensorMerging/tree/master/ADSM%20evaluation/100cases/100casesR4)
