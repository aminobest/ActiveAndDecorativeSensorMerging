...
public class GUIUtils {
	...
	public static JLabel prepareLabel(String s) {
		return prepareLabel(s, SwingConstants.LEFT, Color.darkGray);
	}
	...
	public static JLabel prepareLabel(int i) {
		return prepareLabel(i, SwingConstants.LEFT, Color.darkGray);
	}
	...
	public static JPanel wrapInRoundedPanel(JComponent c) {
		JPanel wrapper = new RoundedPanel(10);
